...
Bootstrap is a sleek, intuitive, and powerful front-end framework for faster and easier web development, created by [James David](https://twitter.com/mdo) and [David Jone](https://twitter.com/fat), and maintained by the [James, David](https://github.com/orgs/twbs/people) with the massive support and involvement of the community.
